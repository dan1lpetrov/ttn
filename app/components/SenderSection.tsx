        ...
        <>
            ...
            <div className="mb-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                    {locations.slice(0, locations.length > 8 && visibleLocationsCount === 8 ? 7 : visibleLocationsCount).map((location) => (
                        <div
                            key={location.id}
                        ...
                        >
                            <div className="text-sm font-medium truncate">{location.city_name}</div>
                            <div className="text-xs text-gray-500 dark:text-gray-400 truncate">{location.sender_address_name}</div>
                        </div>
                    ))}
                    {locations.length > 8 && visibleLocationsCount < locations.length && (
                        <button
